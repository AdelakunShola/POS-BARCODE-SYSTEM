...
// Include custom font
$pdf = new FPDF();
$pdf->AddFont('ArialUnicode', '', 'times.php');
...
$pdf->Cell(60,5,'PHONE NUMBER : 09136608110',0,1,'C');
$pdf->Cell(60,5,'WEBSITE  : WWW.CLOUDMOTION.TECH',0,1,'C');
...
$pdf->Cell(25,5,'SUBTOTAL(N)',1,0,'C');
...
$pdf->SetFont('courier','B',8);
$pdf->Cell(20,5,'',0,0,'L'); //190
$pdf->Cell(25,5,'DISCOUNT (N)',1,0,'C');
...
$pdf->SetFont('courier','B',8);
$pdf->Cell(20,5,'',0,0,'L'); //190
$pdf->Cell(25,5,'PAID(N)',1,0,'C');
$pdf->Cell(20,5,$row->paid,1,1,'C');

$pdf->SetX(7);
$pdf->SetFont('courier','B',8);
$pdf->Cell(20,5,'',0,0,'L'); //190
$pdf->Cell(25,5,'DUE(N)',1,0,'C');
