...
if (isset($_POST['btnsave'])) {
    ...
    if (isset($_POST['txtemail'])) {
        ...
        if ($select->rowCount() >0){
            ...
            $_SESSION['status']="Email already exists. Create with new email";
            $_SESSION['status_code']='warning';
            ...
            $_SESSION['status']="user inserted into the database Successfully";
            $_SESSION['status_code']='success';
        
        }else{
            $_SESSION['status']="Error occured while inserting user into database";
