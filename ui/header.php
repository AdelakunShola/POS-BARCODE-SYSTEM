...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav  style="background-color: #;" class="main-header navbar navbar-expand navbar-white navbar-light">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li  class="nav-item">
  ...
  <aside style="background-color: #0c0b10;" class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
